 ...
 * @export
 * @interface ServerReadSpec
 */
export interface ServerReadSpec {
    /**
...
/**
 * Check if a given object implements the ServerReadSpec interface.
 */
export function instanceOfServerReadSpec(value: object): boolean {
    let isInstance = true;
...
export function ServerReadSpecFromJSON(json: any): ServerReadSpec {
    return ServerReadSpecFromJSONTyped(json, false);
}

export function ServerReadSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerReadSpec {
...
export function ServerReadSpecToJSON(value?: ServerReadSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
